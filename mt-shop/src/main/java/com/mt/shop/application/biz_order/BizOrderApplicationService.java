package com.mt.shop.application.biz_order;
...
public class BizOrderApplicationService {
    ...
    public void handle(InternalCreateNewOrderCommand command) {
        ApplicationServiceRegistry.getIdempotentWrapper().idempotentMsg(command.getChangeId(), (change) -> {
            try {
