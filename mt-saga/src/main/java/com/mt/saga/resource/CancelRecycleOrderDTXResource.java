...
public class CancelRecycleOrderDTXResource {
    ...
    public ResponseEntity<?> readForAdminByQuery(
        ...
        SumPagedRep<CancelRecycleOrderDTX> dtx = ApplicationServiceRegistry.getCancelRecycleOrderDTXApplicationService().query(queryParam, pageParam, skipCount);
    ...
    public ResponseEntity<?> readForAdminById(
        ...
        Optional<CancelRecycleOrderDTX> dtx = ApplicationServiceRegistry.getCancelRecycleOrderDTXApplicationService().query(id);
