...
@Getter
public class ConfirmOrderPaymentDTXQuery extends QueryCriteria {
    ...
    private ConfirmOrderPaymentSort sort;
    public ConfirmOrderPaymentDTXQuery(String queryParam, String pageParam, String skipCount) {
    ...
    public ConfirmOrderPaymentDTXQuery(String changeId) {
    ...
    private void setSort(PageConfig pageConfig) {
        if (pageConfig.getSortBy().equalsIgnoreCase("id")) {
            this.sort = ConfirmOrderPaymentSort.byId(pageConfig.isSortOrderAsc());
        }
    }
    @Getter
    public static class ConfirmOrderPaymentSort {
        private boolean isById;
        private final boolean isAsc;

        private ConfirmOrderPaymentSort(boolean isAsc) {
            this.isAsc = isAsc;
        }

        public static ConfirmOrderPaymentSort byId(boolean isAsc) {
            ConfirmOrderPaymentSort skuSort = new ConfirmOrderPaymentSort(isAsc);
            skuSort.isById = true;
            return skuSort;
        }
    }
