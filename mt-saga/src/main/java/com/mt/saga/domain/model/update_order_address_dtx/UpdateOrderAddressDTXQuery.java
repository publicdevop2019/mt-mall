...
@Getter
public class UpdateOrderAddressDTXQuery extends QueryCriteria {
    ...
    private UpdateOrderAddressSort sort;
    public UpdateOrderAddressDTXQuery(String queryParam, String pageParam, String skipCount) {
    ...
    public UpdateOrderAddressDTXQuery(String changeId) {
    ...
    private void setSort(PageConfig pageConfig) {
        if (pageConfig.getSortBy().equalsIgnoreCase("id")) {
            this.sort = UpdateOrderAddressSort.byId(pageConfig.isSortOrderAsc());
        }
    }
    @Getter
    public static class UpdateOrderAddressSort {
        private boolean isById;
        private final boolean isAsc;

        private UpdateOrderAddressSort(boolean isAsc) {
            this.isAsc = isAsc;
        }

        public static UpdateOrderAddressSort byId(boolean isAsc) {
            UpdateOrderAddressSort skuSort = new UpdateOrderAddressSort(isAsc);
            skuSort.isById = true;
            return skuSort;
        }
    }
