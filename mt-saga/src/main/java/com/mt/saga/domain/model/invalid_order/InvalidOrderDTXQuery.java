...
@Getter
public class InvalidOrderDTXQuery extends QueryCriteria {
    ...
    private InvalidOrderDTXSort sort;
    public InvalidOrderDTXQuery(String queryParam, String pageParam, String skipCount) {
    ...
    public InvalidOrderDTXQuery(String changeId) {
    ...
    private void setSort(PageConfig pageConfig) {
        if (pageConfig.getSortBy().equalsIgnoreCase("id")) {
            this.sort = InvalidOrderDTXSort.byId(pageConfig.isSortOrderAsc());
        }
    }
    @Getter
    public static class InvalidOrderDTXSort {
        private boolean isById;
        private final boolean isAsc;

        private InvalidOrderDTXSort(boolean isAsc) {
            this.isAsc = isAsc;
        }

        public static InvalidOrderDTXSort byId(boolean isAsc) {
            InvalidOrderDTXSort skuSort = new InvalidOrderDTXSort(isAsc);
            skuSort.isById = true;
            return skuSort;
        }
    }
