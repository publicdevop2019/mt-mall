...
@Getter
public class CancelConcludeOrderDTXQuery extends QueryCriteria {
    ...
    private CancelConcludeOrderDTXSort sort;
    public CancelConcludeOrderDTXQuery(String queryParam, String pageParam, String skipCount) {
    ...
    public CancelConcludeOrderDTXQuery(String changeId) {
    ...
    private void setSort(PageConfig pageConfig) {
        if (pageConfig.getSortBy().equalsIgnoreCase("id")) {
            this.sort = CancelConcludeOrderDTXSort.byId(pageConfig.isSortOrderAsc());
        }
    }
    @Getter
    public static class CancelConcludeOrderDTXSort {
        private boolean isById;
        private final boolean isAsc;

        private CancelConcludeOrderDTXSort(boolean isAsc) {
            this.isAsc = isAsc;
        }

        public static CancelConcludeOrderDTXSort byId(boolean isAsc) {
            CancelConcludeOrderDTXSort skuSort = new CancelConcludeOrderDTXSort(isAsc);
            skuSort.isById = true;
            return skuSort;
        }
    }
