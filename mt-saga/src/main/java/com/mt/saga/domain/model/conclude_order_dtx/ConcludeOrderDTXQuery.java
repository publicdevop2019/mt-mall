...
@Getter
public class ConcludeOrderDTXQuery extends QueryCriteria {
    ...
    private ConcludeOrderSort sort;
    public ConcludeOrderDTXQuery(String queryParam, String pageParam, String skipCount) {
    ...
    public ConcludeOrderDTXQuery(String changeId) {
    ...
    private void setSort(PageConfig pageConfig) {
        if (pageConfig.getSortBy().equalsIgnoreCase("id")) {
            this.sort = ConcludeOrderSort.byId(pageConfig.isSortOrderAsc());
        }
    }
    @Getter
    public static class ConcludeOrderSort {
        private boolean isById;
        private final boolean isAsc;

        private ConcludeOrderSort(boolean isAsc) {
            this.isAsc = isAsc;
        }

        public static ConcludeOrderSort byId(boolean isAsc) {
            ConcludeOrderSort skuSort = new ConcludeOrderSort(isAsc);
            skuSort.isById = true;
            return skuSort;
        }
    }
