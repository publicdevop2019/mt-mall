...
@Getter
public class CreateOrderDTXQuery extends QueryCriteria {
    ...
    private CreateOrderDTXSort sort;
    public CreateOrderDTXQuery(String queryParam, String pageParam, String skipCount) {
    ...
    public CreateOrderDTXQuery(String changeId) {
    ...
    private void setSort(PageConfig pageConfig) {
        if (pageConfig.getSortBy().equalsIgnoreCase("id")) {
            this.sort = CreateOrderDTXSort.byId(pageConfig.isSortOrderAsc());
        }
    }
    @Getter
    public static class CreateOrderDTXSort {
        private boolean isById;
        private final boolean isAsc;

        private CreateOrderDTXSort(boolean isAsc) {
            this.isAsc = isAsc;
        }

        public static CreateOrderDTXSort byId(boolean isAsc) {
            CreateOrderDTXSort skuSort = new CreateOrderDTXSort(isAsc);
            skuSort.isById = true;
            return skuSort;
        }
    }
