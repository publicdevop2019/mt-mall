...
@Getter
public class CancelInvalidOrderDTXQuery extends QueryCriteria {
    ...
    private CancelInvalidOrderDTXSort sort;
    public CancelInvalidOrderDTXQuery(String queryParam, String pageParam, String skipCount) {
    ...
    public CancelInvalidOrderDTXQuery(String changeId) {
    ...
    private void setSort(PageConfig pageConfig) {
        if (pageConfig.getSortBy().equalsIgnoreCase("id")) {
            this.sort = CancelInvalidOrderDTXSort.byId(pageConfig.isSortOrderAsc());
        }
    }
    @Getter
    public static class CancelInvalidOrderDTXSort {
        private boolean isById;
        private final boolean isAsc;

        private CancelInvalidOrderDTXSort(boolean isAsc) {
            this.isAsc = isAsc;
        }

        public static CancelInvalidOrderDTXSort byId(boolean isAsc) {
            CancelInvalidOrderDTXSort skuSort = new CancelInvalidOrderDTXSort(isAsc);
            skuSort.isById = true;
            return skuSort;
        }
    }
