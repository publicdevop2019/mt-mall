...
@Getter
public class CancelCreateOrderDTXQuery extends QueryCriteria {
    ...
    private CancelCreateOrderDTXSort sort;
    public CancelCreateOrderDTXQuery(String queryParam, String pageParam, String skipCount) {
    ...
    public CancelCreateOrderDTXQuery(String changeId) {
    ...
    private void setSort(PageConfig pageConfig) {
        if (pageConfig.getSortBy().equalsIgnoreCase("id")) {
            this.sort = CancelCreateOrderDTXSort.byId(pageConfig.isSortOrderAsc());
        }
    }
    @Getter
    public static class CancelCreateOrderDTXSort {
        private boolean isById;
        private final boolean isAsc;

        private CancelCreateOrderDTXSort(boolean isAsc) {
            this.isAsc = isAsc;
        }

        public static CancelCreateOrderDTXSort byId(boolean isAsc) {
            CancelCreateOrderDTXSort skuSort = new CancelCreateOrderDTXSort(isAsc);
            skuSort.isById = true;
            return skuSort;
        }
    }
