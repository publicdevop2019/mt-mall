...
@Getter
public class CancelRecycleOrderDTXQuery extends QueryCriteria {
    ...
    private CancelRecycleOrderDTXSort sort;
    public CancelRecycleOrderDTXQuery(String queryParam, String pageParam, String skipCount) {
    ...
    public CancelRecycleOrderDTXQuery(String changeId) {
    ...
    private void setSort(PageConfig pageConfig) {
        if (pageConfig.getSortBy().equalsIgnoreCase("id")) {
            this.sort = CancelRecycleOrderDTXSort.byId(pageConfig.isSortOrderAsc());
        }
    }
    @Getter
    public static class CancelRecycleOrderDTXSort {
        private boolean isById;
        private final boolean isAsc;

        private CancelRecycleOrderDTXSort(boolean isAsc) {
            this.isAsc = isAsc;
        }

        public static CancelRecycleOrderDTXSort byId(boolean isAsc) {
            CancelRecycleOrderDTXSort skuSort = new CancelRecycleOrderDTXSort(isAsc);
            skuSort.isById = true;
            return skuSort;
        }
    }
