...
@Getter
public class ReserveOrderDTXQuery extends QueryCriteria {
    ...
    private ReserveOrderDTXSort sort;
    public ReserveOrderDTXQuery(String queryParam, String pageParam, String skipCount) {
    ...
    public ReserveOrderDTXQuery(String changeId) {
    ...
    private void setSort(PageConfig pageConfig) {
        if (pageConfig.getSortBy().equalsIgnoreCase("id")) {
            this.sort = ReserveOrderDTXSort.byId(pageConfig.isSortOrderAsc());
        }
    }
    @Getter
    public static class ReserveOrderDTXSort {
        private boolean isById;
        private final boolean isAsc;

        private ReserveOrderDTXSort(boolean isAsc) {
            this.isAsc = isAsc;
        }

        public static ReserveOrderDTXSort byId(boolean isAsc) {
            ReserveOrderDTXSort skuSort = new ReserveOrderDTXSort(isAsc);
            skuSort.isById = true;
            return skuSort;
        }
    }
