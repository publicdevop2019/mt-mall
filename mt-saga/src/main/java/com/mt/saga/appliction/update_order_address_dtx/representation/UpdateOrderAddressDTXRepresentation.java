...
public class UpdateOrderAddressDTXRepresentation extends CommonDTXRepresentation {
    ...
    public UpdateOrderAddressDTXRepresentation(DistributedTx var0) {
        setId(var0.getId());
        setStatus(var0.getStatus());
        setChangeId(var0.getChangeId());
        setOrderId(var0.getLockId());
        setCreatedAt(var0.getCreatedAt().getTime());
        statusMap.put(UPDATE_ORDER_LTX, var0.getLocalTxStatusByName(UpdateOrderForUpdateOrderAddressEvent.name));
        emptyOptMap.put(UPDATE_ORDER_LTX, var0.isLocalTxEmptyOptByName(UpdateOrderForUpdateOrderAddressEvent.name));
