...
public class CancelUpdateOrderAddressDTXRepresentation extends CommonDTXRepresentation {
    ...
    public CancelUpdateOrderAddressDTXRepresentation(DistributedTx var0) {
        setId(var0.getId());
        setStatus(var0.getStatus());
        setChangeId(var0.getChangeId());
        setOrderId(var0.getLockId());
        setCreatedAt(var0.getCreatedAt().getTime());
        statusMap.put(CANCEL_UPDATE_ORDER_LTX, var0.getLocalTxStatusByName(CancelUpdateOrderForUpdateOrderAddressEvent.name));
        emptyOptMap.put(CANCEL_UPDATE_ORDER_LTX, var0.isLocalTxEmptyOptByName(CancelUpdateOrderForUpdateOrderAddressEvent.name));
